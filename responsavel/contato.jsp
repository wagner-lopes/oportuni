			...
			<h:form>
				<htm:table styleClass="contatoInterno">
					...
					<htm:tr styleClass="item">
						...
						<htm:td>
							<t:inputText value="#{responsavelContatoBean.nome}"
								maxlength="50" size="50"></t:inputText>
						</htm:td>
					</htm:tr>
					...
					<htm:tr styleClass="item">
						...
						<htm:td>
							<t:inputText value="#{responsavelContatoBean.email}"
								maxlength="40" size="40"></t:inputText>
						</htm:td>
					</htm:tr>
					...
					<htm:tr styleClass="item">
						...
						<htm:td>
							<t:inputText value="#{responsavelContatoBean.assunto}"
								maxlength="84" size="84"></t:inputText>
						</htm:td>
					</htm:tr>
					...
					<htm:tr styleClass="item">
						...
						<htm:td>
							<t:inputTextarea cols="86" rows="15"
								value="#{responsavelContatoBean.mensagem}"></t:inputTextarea>
						</htm:td>
					</htm:tr>
				</htm:table>
				...
				<t:div styleClass="menuContatoInterno">
					<t:div styleClass="item">
						<a4j:commandButton value="Enviar"
							action="#{responsavelContatoBean.enviarEmail}" reRender="avisos"></a4j:commandButton>
					</t:div>
					<t:div styleClass="item">
